...
- [📝 Research Blogs & Technical Write-ups](#-research-blogs--technical-write-ups)
  ...
  - [RISC-V Security Research](#risc-v-security-research)
- [📄 Research Papers](#-research-papers)
  ...
  - [RISC-V Security](#risc-v-security)
- [🛠 Tools](#-tools)
...
| **Low Byte Productions** | Bare metal STM32 Cortex-M4 series - bootloaders, firmware signing, security | [YouTube](https://www.youtube.com/@LowByteProductions) |
| **Low Level** | Embedded systems, ARM internals, OS dev, hardware-close programming | [YouTube](https://www.youtube.com/@LowLevelTV) |
| **Wrong Baud** | Hardware hacking, SPI/UART/JTAG extraction, NAND flash analysis | [YouTube](https://www.youtube.com/@wrongbaud) |
...
| [JTAG/UART Hacking a Yamaha Keyboard](https://defcon.org/html/defcon-33/dc-33-speakers.html) | porta @ DEF CON 33 | 2025 | Hardware RE of Yamaha synth - JTAG/UART firmware dump, MIDI backdoor discovery, ARM7TDMI exploitation |
...
| [Hands-on IoT Firmware Extraction & Flash Forensics](https://defcon.org/html/defcon-33/dc-33-workshops.html) | Dennis Giese @ DEF CON 33 | 2025 | eMMC BGA chip-off, SPI flash dumping, NAND extraction - hands-on workshop with real devices |
...
| 2025 (DC33) | **JTAG/UART Reverse Engineering a Yamaha Keyboard** | porta | ARM7TDMI RE, MIDI SysEx backdoor, firmware dump | [DEF CON](https://defcon.org/html/defcon-33/dc-33-speakers.html) |
| 2025 (DC33) | **Gateways to Chaos: Modems Are a Ticking Time Bomb** | Multiple | Edge device firmware exploitation, modem security | [DEF CON](https://defcon.org/html/defcon-33/dc-33-speakers.html) |
| 2025 (DC33) | **eMMC BGA Secrets** | DEF CON HHV | BGA memory removal, flash hacking, image backdoor | [DC HHV](https://dchhv.org/schedule/schedule.html) |
| 2025 (DC33) | **Draytek Router Full Exploitation Chain** | Gaston Aznarez | CVE-2024-51138/51139, firmware persistence, unauthenticated RCE | [DC HHV](https://dchhv.org/schedule/schedule.html) |
...
|------|-----------|-----------|-------|------|
| 2025 | **Fuzz Testing Bare Metal and RTOS Firmware** | Tobias Scharnowski, Marius Muench | BOOTSTRAP25 (Ringzer0) | [Ringzer0](https://ringzer0.training/bootstrap25-workshop-fuzz-testing-bare-metal-and-rtos-firmware/) |
...
| [Embedded Reverse Engineering with Firmware Ninja](https://binary.ninja/2025/04/02/firmware-ninja.html) | Binary Ninja (Apr 2025) | **NEW** - Firmware Ninja (FWN) plugin for bare metal memory map construction, peripheral analysis, and inter-device communication RE |
...
| [Reverse Engineering Bare-Metal Firmware (3-Part Series)](https://medium.com/geekculture/reverse-engineering-bare-metal-firmware-part-3-analyzing-arm-assembly-and-exploiting-3b2dbe219f19) | Ragnar Security / WittsEnd2 | Multi-part series covering ARM assembly analysis and bare metal vulnerability exploitation |
...
| Title | Author / Source | Description |
|-------|----------------|-------------|
| [DOSS Bare-Metal Firmware Fuzzing](https://dossproject.eu/doss-bare-metal-firmware-fuzzing/) | Fraunhofer FOKUS / EU DOSS Project (2025) | **NEW** - EU-funded Component Tester for bare metal and RTOS firmware fuzzing in IoT supply chain security |
...
| Title | Author / Source | Description |
|-------|----------------|-------------|
| [RISC-V Security Overview](https://riscv.org/security/) | RISC-V International | Official security resource hub - whitepapers on supervisor domains, isolation, cryptographic ISE |
| [Pre-silicon Security Analysis of RISC-V Processors to Fault Injection](https://riscv-europe.org/summit/2025/media/proceedings/2025-05-14-RISC-V-Summit-Europe-P1.3.10-COUROUSS%C3%89-abstract.pdf) | RISC-V Summit Europe 2025 | Methodology and tools for FI analysis on OpenTitan secure core and CV32E40S |
| [Attacks, Defenses and Perspectives for Runtime Security of RISC-V IoT Devices](https://www.sciencedirect.com/science/article/abs/pii/S0167404825005061) | Computers & Security (Jan 2026) | Comprehensive review of side-channel, vulnerability exploitation, and network attacks on RISC-V |
| [A Survey on Thwarting Memory Corruption in RISC-V](https://dl.acm.org/doi/10.1145/3604906) | ACM Computing Surveys | Hardware-assisted memory safety for RISC-V - XoM, CFI, capability systems |
...
| [Bare-Metal Firmware Fuzzing: A Survey of Techniques and Tools](https://ieeexplore.ieee.org/iel8/6287639/10820123/11020638.pdf) | IEEE Access | 2025 | Comprehensive survey of emulation-based bare metal fuzzing (HALucinator, P2IM, Fuzzware, SAFIREFUZZ, PartEmu) |
| [A Survey on IoT & Embedded Device Firmware Security](https://link.springer.com/article/10.1007/s43926-023-00045-2) | Springer - Discover IoT | 2023 | Architecture, extraction techniques, and vulnerability analysis frameworks; UART found exploitable in 45%+ of devices |
| [A Survey of the Security Analysis of Embedded Devices](https://www.mdpi.com/1424-8220/23/22/9221) | MDPI Sensors | 2023 | Type I/II/III embedded device taxonomy, firmware analysis pipeline, attack surface mapping |
...
| [Securing LLM-Generated Embedded Firmware through AI Agent-Driven Validation](https://arxiv.org/html/2509.09970v1) | arXiv | 2025 | **NEW** - Three-phase LLM firmware generation + automated fuzzing/static analysis + AI agent patching on FreeRTOS/QEMU |
...
| [Leveraging Firmware RE for Stealthy Sensor Attacks via Binary Modification](https://eurekamag.com/research/100/100/100100372.php) | IEEE TIFS | 2023 | **NEW** - PMIC voltage manipulation through firmware binary modification; undetectable sensor data corruption |
| [A Secure Boot and Firmware Update Framework for ARM Cortex-M in IIoT](https://ecejournals.in/index.php/PECE/article/download/432/682/2271) | PECE | 2026 | **NEW** - Two-stage secure bootloader for Cortex-M33 with TrustZone-M, anti-rollback, CoAP/DTLS OTA |
...
| Paper | Venue | Year | Abstract |
|-------|-------|------|----------|
| [A Survey on RISC-V Security: Hardware and Architecture](https://arxiv.org/pdf/2107.04175) | arXiv | 2021 | Comprehensive survey covering cryptographic ISE, side-channel prevention, PMP, TEE on RISC-V |
| [A Survey of RISC-V Secure Enclaves and Trusted Execution Environments](https://www.mdpi.com/2079-9292/14/21/4171) | MDPI Electronics | 2025 | **NEW** - First comprehensive survey of enclave/TEE architectures for RISC-V; Sanctum, Keystone, DORAMI, AP-TEE |
| [A Survey on Thwarting Memory Corruption in RISC-V](https://dl.acm.org/doi/10.1145/3604906) | ACM Computing Surveys | 2023 | Hardware-assisted memory safety: XoM, CFI, capability systems on open RISC-V cores |
| [Security Challenges Faced by RISC-V Open-source Processors](https://ieeexplore.ieee.org/document/10465851/) | IEEE Conference | 2024 | RISC-V-specific security dynamics, hardware extensions, cryptographic countermeasures |
| [Attacks, Defenses and Perspectives for Runtime Security of RISC-V IoT Devices](https://www.sciencedirect.com/science/article/abs/pii/S0167404825005061) | Computers & Security | 2026 | **NEW** - Side-channel, program exploitation, network attacks - comprehensive defense review |
...
| **Binary Ninja + Firmware Ninja** | Commercial RE platform; **Firmware Ninja** plugin (2025) adds bare metal memory mapping, peripheral analysis, device comms RE | Best-in-class for embedded FW | [binary.ninja](https://binary.ninja) / [FWN Blog](https://binary.ninja/2025/04/02/firmware-ninja.html) |
...
| **Draytek Arsenal** | Toolkit for Draytek router firmware analysis and exploitation | Released at DEF CON 32 HHV | [GitHub](https://github.com/infobyte/draytek-arsenal) |
...
| **DOSS Component Tester** | EU-funded IoT/embedded firmware tester for bare metal and RTOS | Supply chain security focused | [DOSS Project](https://dossproject.eu/doss-bare-metal-firmware-fuzzing/) |
...
| **OpenTitan** | Open-source silicon root of trust (RISC-V based) | Reference design for secure MCU research | [GitHub](https://github.com/lowRISC/opentitan) |
...
| [infobyte/draytek-arsenal](https://github.com/infobyte/draytek-arsenal) | DEF CON 32 HHV | **NEW** - Draytek firmware analysis and exploitation toolkit |
| [lowbyteproductions/bare-metal-series](https://github.com/lowbyteproductions/bare-metal-series) | YouTube Series | **NEW** - STM32 Cortex-M4 bare metal firmware dev: bootloader, signed FW, security bypass |
...
| [lowRISC/opentitan](https://github.com/lowRISC/opentitan) | SystemVerilog/C | **NEW** - Open-source silicon root of trust; RISC-V based secure MCU |
...
| **Architecture 1001 (ARM)** | OpenSecurityTraining2 | Intermediate | Deep-dive ARM architecture and binary analysis | [ost2.fyi](https://ost2.fyi) |
...
| **DEF CON HHV Badge Challenges** | Annual hardware hacking village badge - PCB RE, firmware extraction, crypto | [dchhv.org](https://dchhv.org) |
...
| Podcast | Focus | Link |
|---------|-------|------|
| **Darknet Diaries** | True stories of hacking and cybercrime, occasional hardware/firmware episodes | [darknetdiaries.com](https://darknetdiaries.com) |
| **Hacked** | Deep dives into hacking stories - has covered BLE chip backdoors, embedded exploits | [Podcast](https://hackeddotcom.com) |
| **IoT Security Podcast** | Dedicated IoT/embedded security featuring researchers like RECESSIM | Various platforms |
| **Risky Business** | News and commentary from security luminaries; covers firmware/hardware research | [risky.biz](https://risky.biz) |
| **The Amp Hour** | Electronics and embedded engineering - hardware design and security crossover | [theamphour.com](https://theamphour.com) |
| **Embedded.fm** | Embedded systems engineering podcast - bare metal development, RTOS, security | [embedded.fm](https://embedded.fm) |
| **Hacker Public Radio** | Community-driven; episodes on hardware hacking, Linux, RE | [hackerpublicradio.org](https://hackerpublicradio.org) |
...
|-----------|----------|-------|------|
| **r/hardwarehacking** | Reddit | Hardware hacking, JTAG/UART, firmware extraction, glitching | [Reddit](https://www.reddit.com/r/hardwarehacking/) |
| **r/ReverseEngineering** | Reddit | Binary RE, firmware analysis, tooling discussions | [Reddit](https://www.reddit.com/r/ReverseEngineering/) |
| **ChipWhisperer Chat** | Discord | Embedded security, SCA, fault injection - official NewAE community | [Discord](https://discord.gg/chipwhisperer) |
| **Joe Grand's Server** | Discord | Hardware hacking, PCB RE, Joe Grand's research | [Discord](https://discord.gg/joegrand) |
| **DEF CON HHV** | In-person + Online | Hardware Hacking Village - soldering, firmware, badge hacking | [dchhv.org](https://dchhv.org) |
| **DEF CON IoT Village** | In-person + Online | IoT exploitation, bug bounties, live device hacking | [iotvillage.org](https://www.iotvillage.org) |
| **Embedded Security CTF Community** | Various | CTF teams focused on embedded/bare metal challenges | Multiple platforms |
| **Binary Ninja Slack/Discord** | Slack/Discord | RE tooling, plugin development, firmware analysis | [binary.ninja](https://binary.ninja) |
| **Ghidra GitHub Discussions** | GitHub | Ghidra scripting, bare metal loader development, SVD integration | [GitHub](https://github.com/NationalSecurityAgency/ghidra/discussions) |
